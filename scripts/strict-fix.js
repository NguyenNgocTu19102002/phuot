...
// Replace everything between `export const destinations: Destination[] = [` and the ending `];`
const regex = /export const destinations: Destination\[\] = \[[\s\S]*?\];/;
content = content.replace(regex, `export const destinations: Destination[] = ${destinationsArray};`);

fs.writeFileSync(destPath, content);
console.log('Fixed entire destinations.ts exactly');
